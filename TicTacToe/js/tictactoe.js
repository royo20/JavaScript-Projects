...
let activePlayer = "X";
//This array stores an array of moves. We use this too determaine win conditions.
let selectedSquares = [];
...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        //This condition checks who's turn is.
        if (activePlayer === "X") {
            //If activePlayer is equal to"X", the x.png is placed in HTML.
            select.style.backgroundImage = "url('images/x(1).png')";
            //Active player may only be "X" or "O" so, if not "X" ir must be"O"
        } else {
    ...
    function computersTurn() {
        ...
        while(!success){
            ...
            //if the andom number evaluates returns true, the been square hasn't been selected yet.
...
//placement sound ("./media/moving.mp3")
...
function resetGame() {
    ...
    for (let i = 0; i < 9; i++) {
        //this variable gets the HTML element for i
