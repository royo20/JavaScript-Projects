...
function Handle_Operator(Next_Operator) {
    ...
    //displayed on the screen to a number snd then store the result in
    ...
    if (First_Operand == null) {
        ...
        //if operator exists, property loopup is performed for the operator
...
Update_Display();
//this section monitors vutton clicks
